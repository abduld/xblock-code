    ...
    grunt.initConfig({
        ...
        htmlmin: {
            all: {
                ...
                files: {
                    'code/public/edit.html': directoryPrivate + '/edit.html',
                    'code/public/view.html': directoryPrivate + '/view.html',
                },
            },
        },
        jshint: {
        ...
        less: {
            ...
            edit: {
                options: {
                    sourceMap: true,
                    sourceMapFilename: 'code/public/edit.less.min.css.map',
                    outputSourceFiles: true,
                    cleancss: true,
                    compress: true,
                },
                files: {
                    'code/public/edit.less.min.css':
